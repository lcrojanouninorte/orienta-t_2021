...
@Component({
  selector: 'ngx-cno-onets-table',
  templateUrl: './cno-onets-table.component.html',
  styleUrls: ['./cno-onets-table.component.scss']
})
export class CnoOnetsTableComponent   {
  ...
  onReportComplete(): void {
    //Get Data from API
    this.loading = true;
    this._surveyService.getTableData("onets").subscribe({
      next: (tableData: any) => {
        this.tableData = tableData;
        this.loading = false;
