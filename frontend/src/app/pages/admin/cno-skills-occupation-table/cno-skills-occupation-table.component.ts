...
@Component({
  selector: 'ngx-cno-skills-occupation-table',
  templateUrl: './cno-skills-occupation-table.component.html',
  styleUrls: ['./cno-skills-occupation-table.component.scss']
})
export class CnoSkillsOccupationTableComponent  {
  ...
  onReportComplete(): void {
    //Get Data from API
    this.loading = true;
    this._surveyService.getTableData("occupations/skills").subscribe({
      next: (tableData: any) => {
        this.tableData = tableData;
        this.loading = false;
