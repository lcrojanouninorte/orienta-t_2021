...
@Component({
  selector: 'ngx-cno-onets-outputs-table',
  templateUrl: './cno-onets-outputs-table.component.html',
  styleUrls: ['./cno-onets-outputs-table.component.scss']
})
export class CnoOnetsOutputsTableComponent   {
  ...
  onReportComplete(): void {
    //Get Data from API
    this.loading = true;
    this._surveyService.getTableData("onets/outputs").subscribe({
      next: (tableData: any) => {
        this.tableData = tableData;
        this.loading = false;
